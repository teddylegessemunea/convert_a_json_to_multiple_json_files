...
# to create single train json files for ms_coco person_keypoints_train2017.json file
create_single_json_file('ms_coco', 'train2017')

# to create single val json files for ms_coco person_keypoints_train2017.json file
